    ...
    render() {
        return (
            <ScrollView style={styles.container}>
                <View style={{borderColor:'#f8f8f8',borderWidth:1,borderRadius:5,marginBottom:10,paddingLeft:10}}>
                    <View>
                        <Text>感谢您对同城快药的信任，期待您的再次光临</Text>
                    </View>
                    <View  style={{flexDirection:'row',marginTop:10}}>
                        <Button
                            buttonStyle={{borderRadius:5,height:15,width:70,backgroundColor:"#5FA9FF"}}
                            title="再来一单"
                            titleStyle={{fontSize:12}}
                            onPress={()=>this.props.navigation.navigate('MerchantReceive')}
                        />
                        <Button
                            buttonStyle={{marginLeft:20,borderRadius:5,height:15,width:70,backgroundColor:"#5FA9FF"}}
                            title="评价"
                            titleStyle={{fontSize:12}}
